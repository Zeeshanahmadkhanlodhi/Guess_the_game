...
function compareGusses() {
   const userGuess = Number(document.getElementById("inputBox").value); 
   userGasses.push(" " + userGuess);
   document.getElementById("guesses").innerHTML = userGasses; 
   attemtps++
   document.getElementById("attempts").innerHTML = attemtps;

  if (attemtps < maxGuesses){
       if(userGuess > computerGuess){
        ...
        document.getElementById("textOutput").innerHTML = "Correct! You got it in " + attemtps + " attempts";
        gameEnded()
   }
  }else{
      if(userGuess > computerGuess){
